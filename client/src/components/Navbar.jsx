...
const Navbar = () => {
  ...
  return (
    <>
        ...
        <div className="flex items-center gap-4">
          ...
          {user ? (
            <div className="flex items-center gap-2 group relative cursor-pointer">
              ...
              <div className="flex items-center gap-1 ">
                <img
                  ...
                  alt="User avatar"
                  className="w-8 h-8 rounded-full object-cover border-2 border-amber-300 hover:border-amber-400 transition"
                />
                <img
                  src={assets.dropdown}
                  alt="dropdown"
              ...
              {/* Dropdown Menu */}
              <div className="absolute pt-14 top-0 right-8 text-base font-medium z-20 hidden group-hover:block">
                <div className="min-w-52 bg-white border border-amber-200 rounded-2xl shadow-lg flex flex-col gap-2 p-4 transition">
                  <p
                    onClick={() => navigate("/profile")}
                    className="cursor-pointer border-b-2 border-transparent hover:border-b-amber-400 hover:text-amber-700 transition-all w-fit"
                  >
                    Profile
                  </p>
                  <p
                  ...
                  <button
                    ...
                    className="cursor-pointer text-red-500 hover:text-white hover:bg-red-500 transition-all flex items-center gap-2 px-3 py-2 rounded-xl"
                  >
                    Logout
                  </button>
                </div>
              ...
              <button className="text-black bg-amber-400 ml-5 px-6 py-2 rounded-full cursor-pointer font-medium hover:bg-amber-500 transition">
                Reserve Table
              </button>
            </div>
          ) : (
            <button
              ...
              className="text-black bg-amber-400 px-8 py-3 rounded-full cursor-pointer font-medium"
            >
              Create account
            </button>
          )}
          ...
          <button onClick={() => setShowMenu(true)}>
            <HiOutlineMenu className="text-3xl text-amber-700 md:hidden cursor-pointer hover:text-amber-800 transition" />
          </button>
        </div>
      </div>
      ...
      >
        <div className="flex itmes-center justify-between px-7 py-4 ">
          <img
            src={assets.logo}
            alt="Logo"
            className="w-12 h-12 ml-4  object-contain cursor-pointer rounded-full bg-amber-200"
          />
          <button>
            <RiCloseLine
